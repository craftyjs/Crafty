(function() {
  ...
  test("avoidCss3dTransforms", function(_) {
    ...
    if (Crafty.support.css3dtransform) {
      _.strictEqual(
        useCss3dTransforms._cssStyles.transform,
  ...
  test("removing DOM component cleans up", function(_) {
    ...
    _.strictEqual(
      element._changed,
      false,
      "no longer gets dirty after removal of 'DOM'"
    );
    _.strictEqual(
      node.parentNode,
      null,
      "no parent node after removal of 'DOM'"
    );
  });
  ...
  test("Removing Color component resets DOM correctly", function(_) {
    ...
    _.notEqual(
      ...
      "transparent",
      "Element is not initially transparent"
    );
    ...
    _.strictEqual(
      node.style.backgroundColor,
      "transparent",
      "Transparent after removal of Color"
    );
  });
})();
