(function() {
  ...
  test("Logging works when console.log is enabled", function(_){
    ...
    _.strictEqual(logged_message, test_message, "Crafty.log correctly passes through to console.log");
    
    Crafty.loggingEnabled = false;
    logged_message = "";
    Crafty.log(test_message);
    _.strictEqual(logged_message, "", "Crafty.log does nothing when logging is disabled.");
    Crafty.loggingEnabled = true;

    logger.log = undefined;
    Crafty.log(test_message);
    _.strictEqual(logged_message, "", "Crafty.log does not crash when console.log is undefined.");
