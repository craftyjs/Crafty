(function() {
  ...
  test("constructor", function(_) {
    ...
    _.strictEqual(
      v0.equals(v00),
      true,
      "new Vector2D() equals new Vector2D(0, 0)"
    );
    _.strictEqual(
      v12.equals(v12_2),
      true,
      "new Vector2D(1, 2) equals new Vector2D(new Vector2D(1,2))"
    );
  });
  ...
  test("angleBetween()", function(_) {
    ...
    _.strictEqual(
      v10.angleBetween(v_11),
      (3 * Math.PI) / 4,
      "<1,0>.angleBetween(<0,1>) = 3*PI/4"
    );
    _.strictEqual(
      v10.angleBetween(v1_1),
      -Math.PI / 4,
      "<1,0>.angleBetween(<1,-1>) = -PI/4"
    );
  });
  ...
  test("equals()", function(_) {
    ...
    _.strictEqual(
      v12.equals(new Vector2D(1, 2)),
      true,
      "<1,2>.equals(<1,2>) = true"
    );
    _.strictEqual(
      v34.equals(new Vector2D(3, 4)),
      true,
      "<3,4>.equals(<3,4>) = true"
    );
    _.strictEqual(
      v46.equals(new Vector2D(4, 6)),
      true,
      "<4,6>.equals(<4,6>) = true"
    );
  });
  ...
  test("perpendicular()", function(_) {
    ...
    _.strictEqual(
      v10.perpendicular().equals(new Vector2D(0, 1)),
      true,
  ...
  test("getNormal()", function(_) {
    ...
    _.strictEqual(
      v10.getNormal(v32).equals(new Vector2D(1, -1).normalize()),
      true,
      "<1,0>.getNormal(<3,2>) = <sqrt(2)/2,-sqrt(2)/2>"
    );
  });
  ...
  test("magnitude()", function(_) {
    ...
    _.strictEqual(
      v_79.magnitude(),
      11.40175425099138,
      "<-7,9>.magnitude() = 11.40175425099138"
    );
  });
  ...
  test("normalize()", function(_) {
    ...
    _.strictEqual(
      v0.normalize().equals(new Vector2D(1, 0)),
      true,
      "<0,0>.normalize() = <1,0>"
    );
    _.strictEqual(
      v01.normalize().equals(new Vector2D(0, 1)),
      true,
      "<0,1>.normalize() = <0,1>"
    );
    _.strictEqual(
      v_79
        .normalize()
        .equals(new Vector2D(-0.6139406135149205, 0.7893522173763263)),
      true,
      "<-7,9>.normalize() = <-0.6139406135149205,0.7893522173763263>"
    );
  });
  ...
  test("scale()", function(_) {
    ...
    _.strictEqual(
      v11.scale(2).equals(new Vector2D(2, 2)),
      true,
      "<1,1>.scale(2) = <2,2>"
    );
    _.strictEqual(
      v11.scale(2, -3).equals(new Vector2D(4, -6)),
      true,
      "<2,2>.scale(2, -3) = <4,-6>"
    );
  });
  ...
  test("scaleToMagnitude()", function(_) {
    ...
    _.strictEqual(
      v34
        .normalize()
        .scaleToMagnitude(5)
        .equals(new Vector2D(3, 4)),
      true,
      "<3,4>.normalize().scaleToMagnitude(5) = <3,4>"
    );
  });
  ...
  test("setValues", function(_) {
    ...
    _.strictEqual(
      ...
      true,
      "<0,0>.setValues(<1,2>) = <1,2>"
    );
    _.strictEqual(
      v0.setValues(v44).equals(v44),
      true,
      "<1,2>.setValues(<4,4>) = <4,4>"
    );
  });
  ...
  test("translate()", function(_) {
    ...
    _.strictEqual(
      v11.translate(2).equals(new Vector2D(3, 3)),
      true,
      "<1,1>.translate(2) = <3,3>"
    );
    _.strictEqual(
      v11.translate(2, -3).equals(new Vector2D(5, 0)),
      true,
      "<3,3>.translate(2, -3) = <5,0>"
    );
  });
  ...
  test("tripleProduct()", function(_) {
    ...
    _.strictEqual(
      Vector2D.tripleProduct(va, vb, vc).equals(vtp),
      true,
      "tripleProduct(<1,2>, <3,4>, <5,6>) = <10,-12>"
    );
  });
  ...
  test("apply()", function(_) {
    _.strictEqual(
      new Matrix2D()
        .rotate(Math.PI / 2)
        .apply(new Vector2D(1, 2))
        .equals(new Vector2D(-2, 1.0000000000000002)),
      true,
      "(new Matrix2D()).rotate(Math.PI/2).apply(new Vector2D(1, 2)).equals(new Vector2D(-2, 1.0000000000000002))"
    );
  });

  test("clone()", function(_) {
    _.strictEqual(
      new Matrix2D(1, 2, 3, 4, 5, 6)
        .clone()
        .equals(new Matrix2D(1, 2, 3, 4, 5, 6)),
      true,
      "(new Matrix2D(1, 2, 3, 4, 5, 6)).clone().equals(new Matrix2D(1, 2, 3, 4, 5, 6))"
    );
  });
  ...
  test("combine()", function(_) {
    _.strictEqual(
      new Matrix2D()
        .scale(2)
        .combine(new Matrix2D().rotate(0.75))
        .equals(new Matrix2D().scale(2).rotate(0.75)),
      true,
      "(new Matrix2D()).scale(2).combine((new Matrix2D()).rotate(0.75)).equals((new Matrix2D()).scale(2).rotate(0.75))"
    );
  });

  test("equals()", function(_) {
    _.strictEqual(
      new Matrix2D().equals(new Matrix2D()),
      true,
      "(new Matrix2D()).equals(new Matrix2D())"
    );
    _.strictEqual(
      new Matrix2D().scale(2).equals(new Matrix2D()),
      false,
      "(new Matrix2D()).scale(2).equals(new Matrix2D())"
    );
  });
  ...
  test("determinant()", function(_) {
    _.strictEqual(
      new Matrix2D()
        ...
        .determinant(),
      6,
      "(new Matrix2D()).scale(2, 3).rotate(Math.PI / 2).determinant()"
    );
  });
  ...
  test("isIdentity()", function(_) {
    _.strictEqual(
      new Matrix2D().isIdentity(),
      true,
      "(new Matrix2D()).isIdentity()"
    );
    _.strictEqual(
      new Matrix2D().scale(2).isIdentity(),
      false,
      "(new Matrix2D()).scale(2).isIdentity()"
    );
  });
  ...
  test("isInvertible()", function(_) {
    _.strictEqual(
      new Matrix2D()
        ...
        .isInvertible(),
      true,
      "(new Matrix2D()).scale(2, 3).rotate(Math.PI / 2).isInvertible()"
    );
    _.strictEqual(
      new Matrix2D()
        .scale(0, 3)
        ...
        .isInvertible(),
      false,
      "(new Matrix2D()).scale(0, 3).rotate(Math.PI / 2).isInvertible()"
    );
  });

  test("preRotate()", function(_) {
    _.strictEqual(
      new Matrix2D().preRotate(0).equals(new Matrix2D()),
      true,
      "(new Matrix2D()).preRotate(0).equals(new Matrix2D())"
    );
    _.strictEqual(
      new Matrix2D()
        .preRotate(Math.PI / 2)
        .equals(new Matrix2D().rotate(Math.PI / 2)),
      true,
      "(new Matrix2D()).preRotate(Math.PI / 2).equals((new Matrix2D()).rotate(Math.PI / 2))"
    );
  });

  test("preScale()", function(_) {
    _.strictEqual(
      new Matrix2D().preScale(2).equals(new Matrix2D(2, 0, 0, 2, 0, 0)),
      true,
      "(new Matrix2D()).preScale(2).equals(new Matrix2D(2, 0, 0, 2, 0, 0))"
    );
    _.strictEqual(
      new Matrix2D().preScale(2.5).equals(new Matrix2D().scale(2.5)),
      true,
      "(new Matrix2D()).preScale(2.5).equals((new Matrix2D()).scale(2.5))"
    );
  });
  ...
  test("preTranslate()", function(_) {
    _.strictEqual(
      new Matrix2D().preTranslate(1, 2).equals(new Matrix2D(1, 0, 0, 1, 1, 2)),
      true,
      "(new Matrix2D()).preTranslate(1, 2).equals(new Matrix2D(1, 0, 0, 1, 1, 2)"
    );
    _.strictEqual(
      new Matrix2D()
        .preTranslate(1, 2)
        .equals(new Matrix2D().translate(new Vector2D(1, 2))),
      true,
      "(new Matrix2D()).preTranslate(1, 2).equals((new Matrix2D()).translate(new Vector2D(1, 2)))"
    );
    _.strictEqual(
      new Matrix2D()
        .preTranslate(new Vector2D(1, 2))
        .equals(new Matrix2D(1, 0, 0, 1, 1, 2)),
      true,
      "(new Matrix2D()).preTranslate(new Vector2D(1, 2)).equals(new Matrix2D(1, 0, 0, 1, 1, 2))"
    );
    _.strictEqual(
      new Matrix2D()
        .preTranslate(new Vector2D(1, 2))
        .equals(new Matrix2D().translate(new Vector2D(1, 2))),
      true,
      "(new Matrix2D()).preTranslate(new Vector2D(1, 2)).equals((new Matrix2D()).translate(new Vector2D(1, 2)))"
    );
  });

  test("rotate()", function(_) {
    _.strictEqual(
      new Matrix2D().rotate(0).equals(new Matrix2D()),
      true,
      "(new Matrix2D()).rotate(0).equals(new Matrix2D())"
    );
  });
  ...
  test("scale()", function(_) {
    _.strictEqual(
      new Matrix2D().scale(2, 3).equals(new Matrix2D(2, 0, 0, 3, 0, 0)),
      true,
      "(new Matrix2D()).scale(2, 3).equals(new Matrix2D(2, 0, 0, 3, 0, 0))"
    );
  });
  ...
  test("setValues()", function(_) {
    _.strictEqual(
      new Matrix2D()
        ...
        .equals(new Matrix2D(1, 2, 3, 4, 5, 6)),
      true,
      "(new Matrix2D()).setValues(1, 2, 3, 4, 5, 6).equals(new Matrix2D(1, 2, 3, 4, 5, 6))"
    );
  });

  test("toString()", function(_) {
    _.strictEqual(
      new Matrix2D().toString(),
  ...
  test("translate()", function(_) {
    _.strictEqual(
      new Matrix2D().translate(1, 2).equals(new Matrix2D(1, 0, 0, 1, 1, 2)),
      true,
      "(new Matrix2D()).translate(1, 2).equals(new Matrix2D(1, 0, 0, 1, 1, 2))"
    );
    _.strictEqual(
      new Matrix2D()
        ...
        .equals(new Matrix2D(1, 0, 0, 1, 1, 2)),
      true,
      "(new Matrix2D()).translate(new Vector2D(1, 2)).equals(new Matrix2D(1, 0, 0, 1, 1, 2))"
    );
  });
})();
