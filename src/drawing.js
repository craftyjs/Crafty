...
Crafty.extend({
    ...
    * @param obj - Function to execute when scene is played or Object parameter to pass when initializing scene
    * @param uninit - Function to execute before next scene is played, after entities with `2D` are destroyed
    * @sign public void Crafty.scene(String sceneName, Object obj)
    * @param sceneName - Name of scene to play
    * 
    * Method to create scenes on the stage. Pass an ID and function to register a scene.
    *
    * To play a scene, just pass the ID and an optional parameter. When a scene is played, all
